 ...
 *
 * <p>
 * Clase abstracta encargada de definir los métodos y atributos de un Personaje.<br>
...
public abstract class Personaje extends SuperPersonaje implements Peleable, Serializable {
  ...
  /**
   * <h3>Metodo getHabilidadesCasta</h3> metodo que devuelve las hhabilidades de casta que posee un
   * personaje
   * 
   * @return String casta
   */
  ...
  public void setBonus(int bonusSalud, int bonusEnergia, int bonusFuerza, int bonusDestreza,
   ...
   * </p>
   * <p>
   * Este método recibirá un objeto del tipo Peleable al cual, el objeto llamador (un Personaje)
   * intentará atacar.<br>
   * En caso de no poder concretar dicho ataque se retornará un int de valor 0. Si es posible el
   * ataque, se procederá y se retornará un int distinto de cero.
   * </p>
   * 
   * @param atacado
   *          Es un Objeto del tipo Peleable al cual se intenta atacar.
   * @return En caso de No poder concretar el ataque devuelve un cero, caso contrario devuelve un
  ...
  public int atacar(final Peleable atacado) {
    ...
    if (atacado.getSalud() > 0) {
      if (randomGenerator.nextDouble() <= this.casta.getProbabilidadGolpeCritico()
          + this.destreza / 1000) {
   ...
   * Recibirá el daño que se pretende recibir para luego de distintas evaluaciones concretar el
   * ataque recibido.
   * </p>
   * <p>
   * En caso que se pueda evitar el ataque recibido ya sea por defensa oprobabilidad de evitarlo, el
   * método devolverá un cero. Caso contrario se procede a recibir el ataque y luego retornar el
   * daño final.
   * </p>
   * 
   * @param danio
   ...
   * <p>
   * Refresca el estado del personaje atacado a partir de un PaqueteAtacar enviado desde otro
   * cliente
   * </p>
   * 
   * @param paquete
   ...
   * <h3>metodo refreshAtacado</h3>
   * <p>
   * Refresca el estado del personaje atacante a partir de un PaqueteAtacar enviado desde otro
   * cliente
   * </p>
   * 
   * @param paquete
